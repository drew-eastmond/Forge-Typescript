...
(async function() {
  try {
    ...
    execSync(`npx -p typescript@5.6.2 tsc ${BASE}ts/index.ts --declaration --allowJs --emitDeclarationOnly --allowSyntheticDefaultImports --outDir ${DIST}/@types --target esnext --moduleResolution node`, { stdio: "inherit" });
