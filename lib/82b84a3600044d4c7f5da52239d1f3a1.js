...
var Formless_exports = {};
__export(Formless_exports, {
  FormlessElement: () => FormlessElement,
  FormlessEvent: () => FormlessEvent,
...
module.exports = __toCommonJS(Formless_exports);
...
var FormlessElement = class extends HTMLElement {
  ...
  _$connect = (0, import_forge.$UsePromise)();
  _onDOMContentLoaded() {
    const root = this;
