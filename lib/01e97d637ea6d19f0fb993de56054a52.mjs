...
import { $Build, BuilderConfig, Bundle, UncacheFile } from "./fda017fd934f5aa37610fc2a70164a5e.mjs";
...
var BuildClient = class extends ForgeClient {
  ...
  async $library(data, session) {
    ...
    if (build.bundled == Bundle.mangle_static || build.bundled == Bundle.mangle_random || build.bundled == Bundle.preserve) {
      return SerializeResult(await library.$export({ files, root }, new BuilderConfig(build), { lib: "./lib/", ext: ".js" }));
    } else if (build.bundled == Bundle.merge) {
