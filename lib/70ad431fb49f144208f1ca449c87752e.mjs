...
import { TypescriptFile } from "./de65ce5b8faf0fff0b804a86c2074a38.mjs";
...
var ForgeBuilder = class extends Subscription {
  ...
  async $bundle(entry) {
    ...
    const prefix = "Forge_";
    const suffix = "";
    const entryFile = new TypescriptFile({ entry, root: this.root }, { $fetch: this._$fetchTypescript, externals: this._builderOptions.externals });
